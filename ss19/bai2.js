...
let Example = (() => {
    ...
    return _a = class Example {
        ...
        (() => {
            ...
            _processInput_decorators = [validateArguments([isPositive, isNonEmptyString])];
            __esDecorate(_a, null, _processInput_decorators, { kind: "method", name: "processInput", static: false, private: false, access: { has: obj => "processInput" in obj, get: obj => obj.processInput }, metadata: _metadata }, null, _instanceExtraInitializers);
