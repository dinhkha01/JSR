...
let Log = (() => {
    ...
    return _a = class Log {
        ...
        (() => {
            ...
            _test_decorators = [logDecorator];
            __esDecorate(_a, null, _test_decorators, { kind: "method", name: "test", static: false, private: false, access: { has: obj => "test" in obj, get: obj => obj.test }, metadata: _metadata }, null, _instanceExtraInitializers);
