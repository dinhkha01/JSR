...
let Example = (() => {
    ...
    let _someAsyncFunction_decorators;
    return _a = class Example {
        ...
        (() => {
            ...
            _someAsyncFunction_decorators = [timingDecorator];
            __esDecorate(_a, null, _someAsyncFunction_decorators, { kind: "method", name: "someAsyncFunction", static: false, private: false, access: { has: obj => "someAsyncFunction" in obj, get: obj => obj.someAsyncFunction }, metadata: _metadata }, null, _instanceExtraInitializers);
