...
(document.getElementById("studentForm") as HTMLElement).addEventListener(
  "submit",
  function (event) {
    event.preventDefault();

    let idIN = document.getElementById("id") as HTMLInputElement;
    let idSua = document.getElementById("editId") as HTMLInputElement;
    let nameSua = document.getElementById("editName") as HTMLInputElement;
